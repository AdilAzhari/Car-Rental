...
class VehicleFactory extends Factory
{
    public function definition(): array
    {
        ...
        $vehicle = $this->faker->randomElement($vehicleData);
        ...
        return [
            ...
            'daily_rate' => $this->faker->numberBetween(30, 250),
            'location' => $this->faker->city(),
            'pickup_location' => $this->faker->address(),
            'is_available' => $this->faker->boolean(80),
            'insurance_included' => $this->faker->boolean(70),
            'insurance_expiry' => $this->faker->dateTimeBetween('now', '+2 years'),
            'description' => $this->faker->paragraph(3),
            'terms_and_conditions' => $this->faker->paragraph(2),
            'oil_type' => $this->faker->randomElement(['5W-30', '5W-40', '10W-30', '10W-40']),
            'last_oil_change' => $this->faker->optional(0.7)->dateTimeBetween('-1 year', '-1 month'),
            'policy' => $this->faker->optional(0.8)->paragraph(2),
