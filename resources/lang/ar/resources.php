...
return [
    ...
    'user_role_helper' => 'دور المستخدم',
    'password_helper' => 'كلمه المرور',
    'owner_helper_text' => 'المالك',

    // رسائل التحقق - المركبات
    'make_required' => 'علامة المركبة مطلوبة',
    'make_max_length' => 'لا يمكن أن تتجاوز علامة المركبة 100 حرف',
    'model_required' => 'طراز المركبة مطلوب',
    'model_max_length' => 'لا يمكن أن يتجاوز طراز المركبة 100 حرف',
    'year_required' => 'سنة المركبة مطلوبة',
    'year_numeric' => 'يجب أن تكون سنة المركبة رقمًا',
    'year_min' => 'يجب أن تكون سنة المركبة 1990 أو أحدث',
    'year_max' => 'لا يمكن أن تكون سنة المركبة أكثر من السنة القادمة',
    'engine_size_helper' => 'سعة المحرك باللتر (مثال: 2.0, 3.5)',
    'engine_size_max_error' => 'لا يمكن أن تتجاوز سعة المحرك 99.9 لتر',
    'engine_size_min_error' => 'يجب أن تكون سعة المحرك 0.1 لتر على الأقل',
    'engine_size_numeric_error' => 'يجب أن تكون سعة المحرك رقمًا صحيحًا',
    'daily_rate_required' => 'سعر الإيجار اليومي مطلوب',
    'daily_rate_numeric' => 'يجب أن يكون سعر الإيجار اليومي رقمًا',
    'daily_rate_min' => 'لا يمكن أن يكون سعر الإيجار اليومي سالبًا',
    'daily_rate_max' => 'سعر الإيجار اليومي مرتفع جدًا',

    // رسائل تحميل المستندات
    'id_document' => 'وثيقة الهوية',
    'id_document_helper' => 'قم بتحميل نسخة من بطاقة الهوية أو جواز السفر (صورة أو PDF، بحد أقصى 10 ميجابايت)',
    'license_document' => 'وثيقة رخصة القيادة',
    'license_document_helper' => 'قم بتحميل نسخة من رخصة القيادة (صورة أو PDF، بحد أقصى 10 ميجابايت)',
    'file_size_max_error' => 'لا يمكن أن يتجاوز حجم الملف 10 ميجابايت',
    'file_type_error' => 'يجب أن يكون الملف صورة (JPG، PNG) أو PDF',
    'stripe_checkout' => 'Stripe Checkout',
    'maintenance_records' => 'سجلات الصيانة',
    'maintenance_records_description' => 'سجلات الصيانة للمركبة',
