...
class TrafficViolations extends Page
{
    protected static string $resource = VehiclesVehicleResource::class;

    protected string $view = 'filament.resources.vehicle-resource.pages.traffic-violations';
    ...
    {
        return 'Traffic Violations - '.$this->record->plate_number;
    }
    ...
    {
        return $this->record->traffic_violations ?? [];
    }
}
